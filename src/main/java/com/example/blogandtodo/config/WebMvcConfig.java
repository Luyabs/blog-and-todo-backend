package com.example.blogandtodo.config;

import com.example.blogandtodo.common.interceptor.JwtInterceptor;
import com.example.blogandtodo.common.interceptor.Knife4jInterceptor;
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    protected void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // 可考虑使用nginx分离该目录的静态资源
         registry.addResourceHandler("/avatar/**").addResourceLocations("file:///" + avatarBaseUrl);
         registry.addResourceHandler("/note-file/**").addResourceLocations("file:///" + noteFileBaseUrl);
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new JwtInterceptor())   // 访问指定URL需要携带token
                ...
                .excludePathPatterns("/user/login", "/user/hello", "/avatar/**", "/note-file/**", "/doc.html", "/swagger-resources", "/v2/api-docs**", "/webjars/**", "/favicon.ico");
